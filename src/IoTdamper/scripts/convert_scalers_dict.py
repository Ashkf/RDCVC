...
# 读取标准化器字典
scalers_dir = r"D:\OneDrive\01 WORK\# DampersClusterControl\03 IoT damper fitting\mlp-l12-dpTv_BS36_LR0.001_EP500_2023-08-20T21-10-53"
with open(os.path.join(scalers_dir, "scalers_dict.pkl"), "rb") as f:
