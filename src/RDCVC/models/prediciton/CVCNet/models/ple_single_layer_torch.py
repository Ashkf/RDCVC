...
* Author: Fan Kai
* Soochow University
* Created: 2023-11-23 04:12:22
* ----------------------------
* Modified: 2023-11-23 04:12:47
* Modified By: Fan Kai
* ========================================================================
* HISTORY:
"""
...
class PLE(nn.Module):
    ...
    def __init__(
        ...
        self.shared_experts_dnn = nn.ModuleList(
            [
                DNN(
                    inputs_dim,
                    expert_hidden_units,
        ...
        self.task_dense = nn.ModuleList(
            [
                nn.Linear(tower_hidden_units[-1], labels_dict[name], bias=False)
...
class GateNetwork(nn.Module):
    def __init__(
        ...
        self.gates = nn.Linear(
            inputs_dim, num_experts + len(shared_experts_dnn), bias=False
        )
