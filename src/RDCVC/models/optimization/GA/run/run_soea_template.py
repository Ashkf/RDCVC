...
*
*
* File: run_soea_template.py
* Author: Fan Kai
* Soochow University
* Created: 2023-11-15 02:25:51
* ----------------------------
* Modified: 2024-01-02 03:38:52
* Modified By: Fan Kai
* ========================================================================
* HISTORY:
"""
...
import geatpy as ea
from CoreGA.models.problem_soea_api_SUPP_VolPropRMSE import (
    MyProblem,  # 导入自定义问题接口
)
...
if __name__ == "__main__":
    ...
    Ploter.plot(
        algorithm.trace,
        title="Iterative Trace",
        xlabel="Generation",
        ylabel="Volume Proportion",
        save_path=save_dirName + "/" + "trace.png",
        dpi=300,
    )
    # 保存 trace 原始数据
    ...
    res_data = {
        "ref_volume": problem.calReferObjV(),
    ...
    Ploter.plot(
        ...
        xlabel="Room",
        ylabel="Supply Volume (CMH)",
        size=(6.5, 4),
        save_path=save_dirName + "/" + "result.png",
        dpi=300,
    )  # 保存优化后风量图
    plt.show()
    # ================== 输出状态 ==================
